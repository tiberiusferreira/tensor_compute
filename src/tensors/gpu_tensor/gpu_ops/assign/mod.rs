...
use crate::{GpuTensor, TensorTrait, GpuTensorView};
use zerocopy::AsBytes;

#[cfg(test)]
mod tests;

pub async fn assign<'a>(gpu: &GpuInstance, data: &mut GpuTensorView<'a>, assign_data: f32) {
    ...
    gpu.run_shader(
        ...
        vec![
            ShaderInput {
                binding_id: 0,
                gpu_buffer: BufferType::Storage(data.buffer()),
            },
            ShaderInput {
                binding_id: 1,
